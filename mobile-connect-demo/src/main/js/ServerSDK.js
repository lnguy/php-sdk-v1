...
var MobileConnectServerSDK = {
    _config: {
        discoveryUrl: "/start-discovery.php",
        authorizationUrl: "/start-authorisation.php",
        errorPageUrl: "/error-page.php",
        popupWidth: 400,
        popupHeight: 705
    },
            ...
            success: function (data) {
                ...
                if (status == "success") {
                    if (action == "authorization") {
                        me.loginOpenIdConnect(me._config, parameter1);
     ...
     */
    loginOpenIdConnect: function (config, url) {
        var width = config.popupWidth,
            height = config.popupHeight,
            position_x = (screen.width / 2) - (width / 2),
            position_y = (screen.height / 2) - (height / 2);
        window.open(url, "loginOpenIdConnect", "fullscreen=1,menubar=0,toolbar=0,directories=0,scrollbars=yes,resizable=yes,left=" + position_x + ",top=" + position_y + "");
    },
    /**
